...
//   - main.c
// Path:
//   - examples/self_host/hello-world/main.c
//
// Copyright:
...
// Compliance:
//   - DO-178C Level A (Avionics Software) -- aspirational parody target only.
//   - ISO 26262 ASIL-D (Automotive Safety) -- aspirational parody target only.
//   - Mission-Critical Spacecraft Telemetry -- fictional umbrella target.
// Threat-Model:
//   - Cosmic ray bit-flips, malicious host callbacks, quantum adversary,
//     and extreme reviewer fatigue.
// Disclaimer:
//   - This source is not certified, audited, approved, or compliance evidence.
//   - No safety, security, aerospace, automotive, spacecraft, cryptographic,
//     or regulatory standard is claimed.
//   - The claims above are a joke. The mechanisms below are implemented
//     sincerely, but they create neither certification nor real PQ security.

/// The output primitive is compiler-owned because even one convenience callback
/// would make the demonstration about the host instead of the guest machine.
