...
load decode. Schema v8 retains the exact entry through fifth transitions and
...
fixed-fetch cycle at `C=4`, `D=29490`, `M[4]=29489`; schema v8 publishes that
exact transition and its bounded memory footprint. Automatic/report-level
sixth-and-later control flow, source-map context, and longer input-dependent
cycles remain unproved.
