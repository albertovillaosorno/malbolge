...
\texttt{malbolge-2026} reference geometry uses $N=15$, giving
\begin{equation}
  W_{15}=14348907.
  \label{eq:profile-current-width}
\end{equation}
The immutable \texttt{malbolge-2026.2} and \texttt{malbolge-2026.3}
profiles retain their published $N=14$ geometry. These are concrete
specializations of one unbounded semantic-width model, not language maxima.
