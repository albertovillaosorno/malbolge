...
`python src/automation/repository/composition/scripts/validate/math_specifications.py`
...
`python src/automation/repository/composition/scripts/validate/math_correspondence.py`. A manifest link
