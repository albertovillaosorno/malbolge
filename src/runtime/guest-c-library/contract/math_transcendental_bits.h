...
#define MALBOLGE_GUEST_MATH_ATAN2_PROVED_REFINEMENT_STAGE UINT32_C(10574490)
#define MALBOLGE_GUEST_MATH_ATAN2_PROVED_FRACTION_BITS UINT32_C(338383744)
#define MALBOLGE_GUEST_MATH_ATAN2_PROVED_TERMS UINT32_C(42297968)
#define MALBOLGE_GUEST_MATH_ATAN2_PROVED_SCRATCH_LIMBS UINT32_C(158617395)
#define MALBOLGE_GUEST_MATH_ATAN2_PROVED_SCRATCH_BYTES UINT32_C(634469580)
...
} MalbolgeGuestMathFixed2112;

typedef struct MalbolgeGuestMathFixed2112Interval {
  MalbolgeGuestMathFixed2112 lower;
  MalbolgeGuestMathFixed2112 upper;
} MalbolgeGuestMathFixed2112Interval;

typedef struct MalbolgeGuestMathFixed2176 {
  uint32_t limbs[MALBOLGE_GUEST_MATH_FIXED_2176_LIMBS];
} MalbolgeGuestMathFixed2176;

typedef struct MalbolgeGuestMathFixed2176Interval {
  MalbolgeGuestMathFixed2176 lower;
  MalbolgeGuestMathFixed2176 upper;
} MalbolgeGuestMathFixed2176Interval;
