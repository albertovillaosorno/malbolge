...
/// Native object proven to implement guarded explicit-geometry crazy.
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct VerifiedExecutionGeometryCrazyNativeObjectArtifact {
    pub(super) artifact: StructurallyAdmittedNativeObjectArtifact,
}

impl VerifiedExecutionGeometryCrazyNativeObjectArtifact {
...
/// Native object proven to implement guarded explicit-geometry jump-code.
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct VerifiedExecutionGeometryJumpCodeNativeObjectArtifact {
    pub(super) artifact: StructurallyAdmittedNativeObjectArtifact,
}

impl VerifiedExecutionGeometryJumpCodeNativeObjectArtifact {
    /// Returns the exact v5 native artifact identity.
    #[must_use]
    pub const fn key(&self) -> &NativeArtifactKey {
        self.artifact.key()
...
/// Verified v6 halt-fetch object with reduced register/history guards.
///
/// This value is intentionally separate from [`VerifiedDirectNativeArtifact`]
/// so existing load and invocation paths cannot acquire v6 execution authority.
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct VerifiedRegisterMaskedHaltFetchNativeObjectArtifact {
    pub(super) artifact: StructurallyAdmittedNativeObjectArtifact,
}

impl VerifiedRegisterMaskedHaltFetchNativeObjectArtifact {
...
/// Verified v6 no-operation object with reduced register/history guards.
///
/// This value is intentionally object-only so semantic verification does not
/// grant executable-memory or invocation authority.
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct VerifiedRegisterMaskedNoOperationNativeObjectArtifact {
    pub(super) artifact: StructurallyAdmittedNativeObjectArtifact,
}

impl VerifiedRegisterMaskedNoOperationNativeObjectArtifact {
    /// Returns the complete v6 native artifact key.
    #[must_use]
    pub const fn key(&self) -> &NativeArtifactKey {
        self.artifact.key()
...
/// Verified v6 output object with reduced register/history guards.
///
/// This value is intentionally object-only so semantic verification does not
/// grant executable-memory or invocation authority.
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct VerifiedRegisterMaskedOutputNativeObjectArtifact {
    pub(super) artifact: StructurallyAdmittedNativeObjectArtifact,
}

impl VerifiedRegisterMaskedOutputNativeObjectArtifact {
    /// Returns the complete v6 native artifact key.
    #[must_use]
    pub const fn key(&self) -> &NativeArtifactKey {
        self.artifact.key()
...
/// grant executable-memory or invocation authority.
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct VerifiedRegisterMaskedRotateNativeObjectArtifact {
    pub(super) artifact: StructurallyAdmittedNativeObjectArtifact,
}

impl VerifiedRegisterMaskedRotateNativeObjectArtifact {
    /// Returns the complete v6 native artifact key.
    #[must_use]
    pub const fn key(&self) -> &NativeArtifactKey {
        self.artifact.key()
