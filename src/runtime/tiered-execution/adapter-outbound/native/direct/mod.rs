...
mod register_masked_reduced_state_graph_dispatch;
...
pub use plan::{
    ExecutionGeometryDirectSelectionError, admit_direct_jit_candidate,
...
pub use register_masked_reduced_state_graph_codec::*;
pub use register_masked_reduced_state_graph_dispatch::*;
...
/// Backend identity for explicit-geometry one-step jump-code.
pub const DIRECT_EXECUTION_GEOMETRY_JUMP_CODE_BACKEND_ID: &str =
    "direct-execution-geometry-jump-code";
/// Explicit-geometry jump-code code-generation revision.
pub const DIRECT_EXECUTION_GEOMETRY_JUMP_CODE_BACKEND_REVISION: u32 = 1;
/// Backend identity for explicit-geometry one-step jump-data.
pub const DIRECT_EXECUTION_GEOMETRY_JUMP_DATA_BACKEND_ID: &str =
    "direct-execution-geometry-jump-data";
/// Explicit-geometry jump-data code-generation revision.
pub const DIRECT_EXECUTION_GEOMETRY_JUMP_DATA_BACKEND_REVISION: u32 = 1;
...
/// Backend identity for explicit-geometry one-step output.
pub const DIRECT_EXECUTION_GEOMETRY_OUTPUT_BACKEND_ID: &str =
    "direct-execution-geometry-output";
/// Explicit-geometry output code-generation revision.
pub const DIRECT_EXECUTION_GEOMETRY_OUTPUT_BACKEND_REVISION: u32 = 1;
...
/// Backend identity for collapsed v6 two-no-operation execution.
pub const DIRECT_REGISTER_MASKED_NO_OPERATION_PAIR_BACKEND_ID: &str =
...
/// Register-masked v6 output code-generation revision.
pub const DIRECT_REGISTER_MASKED_OUTPUT_BACKEND_REVISION: u32 = 1;
...
/// Register-masked v6 non-graphical code-generation revision.
pub const DIRECT_REGISTER_MASKED_NON_GRAPHICAL_BACKEND_REVISION: u32 = 1;
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(super) struct DirectRegisterMaskedNoOperationPairTemplate {
    pub(super) entry_code_pointer: u32,
    pub(super) entry_data_pointer: u32,
    ...
    pub(super) next_data_pointer: u32,
    pub(super) required_memory_words: u64,
    pub(super) second_code_pointer: u32,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(super) struct DirectRegisterMaskedOutputGuard {
    pub(super) accumulator: u32,
    pub(super) code_live_in: u32,
    pub(super) code_pointer: u32,
    pub(super) data_pointer: u32,
...
#[derive(Clone, Copy, Debug)]
pub(super) struct DirectFusedCrazyOutputTemplate<'live_ins> {
    pub(super) crazy: DirectCrazyCommit,
    pub(super) live_ins: &'live_ins [MemoryLiveIn],
    pub(super) observation: DirectEntryObservation,
...
#[derive(Clone, Copy, Debug)]
pub(super) struct DirectFusedCrazyPairTemplate<'live_ins> {
    pub(super) first: DirectCrazyCommit,
    pub(super) live_ins: &'live_ins [MemoryLiveIn],
    pub(super) observation: DirectEntryObservation,
    pub(super) required_memory_words: u64,
    pub(super) second: DirectCrazyCommit,
}

#[derive(Clone, Copy, Debug)]
pub(super) struct DirectFusedCrazyNoOperationTemplate<'live_ins> {
    pub(super) crazy: DirectCrazyCommit,
    pub(super) live_ins: &'live_ins [MemoryLiveIn],
...
#[derive(Clone, Copy, Debug)]
pub(super) struct DirectFusedInputOutputTemplate<'live_ins> {
    pub(super) input: DirectInputCommit,
    pub(super) input_evidence: TraceInput,
    pub(super) input_index: u64,
    pub(super) live_ins: &'live_ins [MemoryLiveIn],
...
#[derive(Clone, Copy, Debug)]
pub(super) struct DirectFusedNoOperationRotateTemplate<'live_ins> {
    pub(super) live_ins: &'live_ins [MemoryLiveIn],
    pub(super) no_operation: DirectCodeWriteCommit,
    pub(super) observation: DirectEntryObservation,
    pub(super) required_memory_words: u64,
...
#[derive(Clone, Copy, Debug)]
pub(super) struct DirectFusedNoOperationOutputTemplate<'live_ins> {
    pub(super) live_ins: &'live_ins [MemoryLiveIn],
    pub(super) no_operation: DirectCodeWriteCommit,
    pub(super) observation: DirectEntryObservation,
    pub(super) output: DirectOutputCommit,
...
#[derive(Clone, Copy, Debug)]
pub(super) struct DirectFusedRotateNoOperationTemplate<'live_ins> {
    pub(super) live_ins: &'live_ins [MemoryLiveIn],
    pub(super) no_operation: DirectCodeWriteCommit,
    pub(super) observation: DirectEntryObservation,
    pub(super) required_memory_words: u64,
