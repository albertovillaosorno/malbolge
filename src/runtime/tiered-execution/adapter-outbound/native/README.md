...
`direct/fused.rs` now emits thirteen reviewed two-step regions as atomic x86-64
...
rotate/no-operation, rotate/crazy, and rotate/rotate. Both
...
crazy/output, crazy/rotate, crazy/crazy, rotate/crazy, and rotate/rotate shapes
