...
`direct/fused.rs` now emits thirty-three reviewed two-step regions as atomic
x86-64
...
rotate/crazy, rotate/rotate, input/input, input/output, and output/output. Both
...
input/input, input/output, and output/output shapes exercise both ISAs through
emission,
promotion,
