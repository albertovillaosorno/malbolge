...
`direct/fused.rs` now emits thirty-eight reviewed two-step regions as atomic
x86-64
or AArch64 COFF candidates: rotate/output, rotate/jump-code,
rotate/jump-data, crazy/output, input/input, input/output,
crazy/jump-code,
crazy/jump-data,
no-operation/output,
...
rotate/crazy, rotate/rotate, input/input, input/output, output/crazy,
output/rotate, output/jump-data, output/input, output/no-operation, and
output/output. Both
