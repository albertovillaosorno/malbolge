...
`direct/fused.rs` now emits eleven reviewed two-step regions as atomic x86-64
...
crazy/output, crazy/crazy, rotate/crazy, and rotate/rotate shapes exercise both
ISAs through emission, promotion,
