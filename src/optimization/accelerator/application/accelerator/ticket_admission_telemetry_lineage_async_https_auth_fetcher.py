...
# Boundary-Contract:
# - Owns:
#   - Caller-offloaded async adapter for one authorized synchronous HTTPS
#     fetcher.
# - Must-Not:
...
# - Allows:
#   - Inputs: one exact authorized HTTPS fetcher, caller offloader, and
#     requests.
#   - Outputs: the shared typed fetched, unavailable, or failed transport
#     result.
...
# - Usage:
#   - Build from explicit authorized HTTPS state and a caller-selected
#     offloader.
# - Defaults:
