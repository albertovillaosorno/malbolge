...
# - Allows:
#   - Inputs: one exact HTTPS fetcher, request, provider identity, and async
#     port.
...
# - Description:
#   - Reuses synchronous preflight and materialization without scheduling
#     policy.
# - Usage:
...
# ruff: file-ignore[line-too-long,too-many-arguments]
