...
LLVM_BIN = REPO_ROOT / ".dependencies" / "llvm" / "22.1.8" / "jig-bin"
CLANG = LLVM_BIN / "clang.bin"
CLANG_TIDY = LLVM_BIN / "clang-tidy.bin"
CLANG_FORMAT = LLVM_BIN / "clang-format.bin"
...
def _emit_tex(path: Path, comparison: _Comparison) -> None:
    ...
    lines.extend([
        ...
        (
            ...
            + metrics.latex
            + "texttt{src/research/algorithms/domain/algorithms/doom/"
            + "quality/comparison/metrics.json}."
        ),
