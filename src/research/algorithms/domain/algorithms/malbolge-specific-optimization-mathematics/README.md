...
The larger exact `V4-(4,2)` stabilizer branch is constructive too. Its
normalizer has order 16 and quotient order 4 with five subgroups. The H-fixed
residual coordinates have orbit spectrum `1^4 2^8 4^8`; seven quotient blocks
expand to sizes `(4,2,2,2,2,2,2,2,2)` with weights
`(1,2,4,2,2,2,4,4,4)`.

The normalizer-free mass-14 quotient has 30,260 classes. Four transitive
order-12 extensions form one normalizer orbit and account for exactly 393
...
The exact order-eight `(4,2)` branch is constructive as well. Its normalizer
has order 16 and quotient order 2. The H-fixed residual coordinates have orbit
spectrum `1^4 2^4 4^8 8^1`, with seven quotient blocks of sizes
`(4,2,4,1,2,2,2)` and weights `(1,2,4,8,2,4,4)`.

The normalizer-free mass-14 quotient has 19,528 classes. Minimal strict
...
The transitive order-60 stabilizer is constructive too. Its normalizer has
order 120 and quotient order two. The H-fixed residual coordinates have orbit
spectrum `1^2 10^2 15^2`; the quotient rank uses three blocks with sizes
`(2,2,2)` and weights `(1,15,10)`.

Normalizer-free classes occur only at masses 10 through 14, with counts
...
This yields 11,237,656 free triples and 107,758 residual and complete mass-14
classes. The 27 constructive pair-first branches therefore cover all
