...
DEFAULT_SOURCE = ROOT / "algorithms/doom/amalgamate/in/doom.c"
ADAPTER = ROOT / "cli/adapters/doom/windows.c"
...
def _iwad_directories(source_directory: Path) -> tuple[Path, ...]:
    return (
        ...
        ROOT / "doom/data/wad",
        ROOT / "algorithms/doom/quality/out/doom_fixed/data/wad",
    )
