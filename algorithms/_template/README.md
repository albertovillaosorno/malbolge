...
same algorithm. Put reproducible generated artifacts in `out/`, which is ignored
by Git. Ordinary product transformations such as DOOM amalgamation and cleanup do
not belong here.
