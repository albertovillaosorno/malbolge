...
This roadmap contains unfinished work only. Every `### TODO` heading has one
typed record under `todo/roadmap/`. Completed work leaves this file only after
...
Planning is intentionally front-loaded. Before implementation begins, roadmap
...
enough for the roadmap heading to disappear without losing unfinished intent.
