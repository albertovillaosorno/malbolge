# File:
#   - ticket_admission_telemetry_lineage_trust_manifest.py
# Path:
...
def build_ticket_admission_telemetry_lineage_trust_manifest(
    ...
    *,
    ...
    ordered = tuple(
        entries_by_key[key_id] for key_id in sorted(entries_by_key)
    )
...
def _manifest_from_mapping(
    ...
    *,
    ...
    return _validated_manifest(TicketAdmissionTelemetryLineageTrustManifest(
