...
- Current executable evidence covers known-valid source, exact loader
  ...
  opcode through `bounded_continuations`, and a separate 24-case graphical
  ninth-transition CLI differential across `/oo<jjj`, `j*pj*pp`, and
  `o<o<<<<` carried opcode histories and every ninth opcode through
  `bounded_continuations`, and a separate 24-case graphical tenth-transition
  CLI differential across `/oo<jjjj`, `j*pj*ppp`, and `o<o<<<<<` carried
  ...
  covers every sixteenth opcode through `bounded_continuations`. Its
  third carried history keeps C=D for all eight final opcodes; final
  `*` and `p` plan `M[15]=19722` and `M[15]=29504`, respectively. Each
  same-address write becomes self-encryption input and deterministically
  rejects as non-graphical. A separate 24-case graphical
  ...
  `M[16]=39`, consumes that same-address write as self-encryption input,
  encrypts it to 116, and continues. Final `p` plans `M[16]=29502`, consumes
  ...
  separate 24-case graphical nineteenth-transition CLI differential across
  `/oo<jjjjjjj*jjjjj`, `j*pj*ppppj/*jjjjj`, and `o<o<<<<<</o<*oooo` carried
  ...
  `j*pj*ppppj/*jjjjjj`, and `o<o<<<<<</o<*ooooo` carried opcode histories
  covers every twentieth opcode through `bounded_continuations`. Its third
  carried history keeps C=D for all eight final opcodes; final `*` plans
  ...
  continues. Final `p` plans `M[22]=29484`, consumes that same-address write as
  self-encryption input, and deterministically rejects as non-graphical. A
