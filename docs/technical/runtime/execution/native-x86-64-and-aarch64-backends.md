...
The fused emitter now covers seventeen reviewed two-step regions on x86-64 and
...
jump-code/no-operation, jump-data/no-operation,
jump-data/jump-data, no-operation/rotate,
no-operation/crazy,
crazy/no-operation, crazy/rotate,
crazy/crazy, rotate/no-operation, rotate/crazy, and rotate/rotate. Every fused
guard
completes before
the first store,
...
no-operation/jump-data, jump-code/no-operation,
jump-data/no-operation, jump-data/jump-data, no-operation/rotate,
no-operation/crazy,
crazy/no-operation, crazy/output,
crazy/rotate,
