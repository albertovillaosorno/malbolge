...
The fused emitter now covers twenty reviewed two-step regions on x86-64 and
...
jump-data/no-operation, jump-data/jump-code,
...
jump-code/jump-data,
jump-data/no-operation, jump-data/jump-code, jump-data/jump-data,
no-operation/rotate,
no-operation/crazy,
