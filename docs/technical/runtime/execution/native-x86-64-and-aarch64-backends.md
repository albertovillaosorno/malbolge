...
The fused emitter now covers sixteen reviewed two-step regions on x86-64 and
...
jump-code/no-operation, jump-data/no-operation, no-operation/rotate,
no-operation/crazy,
...
jump-data/no-operation, no-operation/rotate,
no-operation/crazy,
