...
The fused emitter now covers eight reviewed two-step regions on x86-64 and
AArch64: rotate/output, no-operation/output, no-operation/no-operation,
no-operation/rotate, no-operation/crazy, crazy/no-operation,
...
no-operation/crazy, crazy/no-operation, rotate/no-operation, and rotate/rotate
objects are also emitted, independently
verified, and
