...
The fused emitter now covers twenty-seven reviewed two-step regions on
x86-64 and AArch64: rotate/output, crazy/output, crazy/jump-data,
no-operation/output,
...
no-operation/rotate,
no-operation/crazy,
crazy/jump-data, crazy/no-operation, crazy/output,
crazy/rotate,
