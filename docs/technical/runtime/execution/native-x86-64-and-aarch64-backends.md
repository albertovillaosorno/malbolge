...
The fused emitter now covers twelve reviewed two-step regions on x86-64 and
AArch64: rotate/output, crazy/output, no-operation/output,
no-operation/no-operation, no-operation/rotate, no-operation/crazy,
crazy/no-operation, crazy/rotate, crazy/crazy, rotate/no-operation,
rotate/crazy, and rotate/rotate. Every fused guard
completes before
the first store,
...
no-operation/crazy, crazy/no-operation, crazy/output, crazy/rotate,
