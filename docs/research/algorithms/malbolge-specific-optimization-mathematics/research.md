...
formalizes one hundred ninety-three exact reductions: classic five-trit crazy
factorization,
...
pair-S2-times-S2, pair-double-transposition, pair-three-pair-V4, pair-S3, and
pair-triple-transposition K6-edge/triple-breaking branches, an exact
