...
formalizes two hundred twenty six exact reductions: classic five-trit crazy
factorization,
...
pair-diagonal-S3-33, pair-D10-51, pair-full-S6-breaking,
pair-transitive-S3-6, pair-transitive-order12, pair-V4-411, pair-point-S5,
pair-C3-33, and pair-transitive-order72 K6-edge/triple-breaking branches, an
exact
S3-extension/S4-exception count decomposition plus an exact S4-extension/point-
S5-exception count decomposition,
dense exact-S4, exact-S3, exact-C2-cubed, exact-S3-times-S2,
exact-V4-(4,1,1), exact-V4-(4,2), exact-order8-(4,1,1),
exact-V4-(2,2,2), exact-order8-(4,2), exact-order16-(4,2),
exact-transitive-order12, exact-transitive-order12-normalizer48,
exact-A4-times-S2, exact-transitive-S4, and exact-transitive-order60
rank/unrank, and an exact repeated-six exact-transposition outer composition for
the remaining all-equal stratum,
a generic
