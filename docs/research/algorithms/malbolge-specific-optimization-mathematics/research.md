...
formalizes two hundred five exact reductions: classic five-trit crazy
factorization,
...
pair-S3-times-S3, pair-S4-411, pair-transitive-order48, pair-D8-411, and
pair-diagonal-S3-33 K6-edge/triple-breaking branches, an exact
