...
formalizes two hundred nineteen exact reductions: classic five-trit crazy
factorization,
...
exact-V4-(4,1,1), exact-V4-(4,2), exact-order8-(4,1,1), and
exact-V4-(2,2,2) rank/unrank, and an exact repeated-six exact-transposition
outer composition for the remaining all-equal stratum,
a generic
