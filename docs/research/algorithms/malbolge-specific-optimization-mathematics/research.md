...
formalizes two hundred twenty two exact reductions: classic five-trit crazy
factorization,
...
exact-V4-(2,2,2), exact-order8-(4,2), exact-order16-(4,2), and
exact-transitive-order12 rank/unrank, and an exact repeated-six
