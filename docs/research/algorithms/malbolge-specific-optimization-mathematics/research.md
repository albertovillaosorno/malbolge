...
formalizes one hundred forty-four exact reductions: classic five-trit crazy
factorization,
...
trivial, S2, S3, and S4 second-layer rank/unrank plus a dense V4 residual
edge rank, where the S4 branch has
