...
formalizes one hundred fifty-five exact reductions: classic five-trit crazy
factorization,
...
quotient/exact rank/unrank, a scalable single-transposition S3 quotient rank,
and exact count plus dense rank/unrank for the double-transposition V4
quotient, where the S4 branch has
complete dense spoke rank/unrank across all five stabilizers and their combined
residual interval, and an exact nested S2-cubed
quotient/fixed-set
 decomposition,
a generic
