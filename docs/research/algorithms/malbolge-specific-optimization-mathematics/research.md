...
formalizes one hundred seventy-seven exact reductions: classic five-trit crazy
factorization,
...
decomposition plus dense exact-S4 and exact-S3 rank/unrank plus an exact
repeated-six
exact-transposition outer count composition for the remaining all-equal stratum,
a generic
