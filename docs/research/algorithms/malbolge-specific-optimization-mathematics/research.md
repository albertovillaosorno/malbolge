...
formalizes one hundred twenty-four exact reductions: classic five-trit crazy
factorization,
...
`(4,1,1)` stratum with dense all-distinct second-layer rank/unrank, and an exact
