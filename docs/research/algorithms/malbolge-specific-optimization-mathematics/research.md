...
formalizes one hundred seventy-five exact reductions: classic five-trit crazy
factorization,
...
decomposition plus dense exact-S4
rank/unrank for the remaining all-equal stratum,
a generic
