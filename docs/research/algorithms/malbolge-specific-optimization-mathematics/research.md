...
formalizes one hundred thirty-nine exact reductions: classic five-trit crazy
factorization,
...
dense all-distinct, S2, and V4 spoke rank/unrank, and an exact nested S2-cubed
quotient/fixed-set
 decomposition,
a generic
