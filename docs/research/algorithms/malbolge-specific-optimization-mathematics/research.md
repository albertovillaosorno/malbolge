...
formalizes one hundred fifty-three exact reductions: classic five-trit crazy
factorization,
...
quotient/exact rank/unrank, and a scalable single-transposition S3 quotient
rank, where the S4 branch has
