...
formalizes one hundred twenty-seven exact reductions: classic five-trit crazy
factorization,
...
`(4,1,1)` stratum with dense all-distinct, S2, and S3 second-layer
rank/unrank plus a dense V4 four-component K4-edge core, and an exact nested
S2-cubed quotient/fixed-set
 decomposition,
a generic
