...
formalizes two hundred twenty one exact reductions: classic five-trit crazy
factorization,
...
exact-V4-(2,2,2), exact-order8-(4,2), and exact-order16-(4,2) rank/unrank,
and an exact repeated-six exact-transposition outer composition for the
remaining all-equal stratum,
a generic
