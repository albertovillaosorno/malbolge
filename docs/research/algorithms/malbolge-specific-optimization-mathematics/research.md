...
formalizes one hundred fifty-nine exact reductions: classic five-trit crazy
factorization,
...
V4 type plus ordered-pattern/strict-color trivial-stabilizer rank/unrank, where
the S4 branch has
