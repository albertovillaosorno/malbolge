...
formalizes one hundred forty-two exact reductions: classic five-trit crazy
factorization,
...
trivial, S2, and S3 second-layer rank/unrank, an S4 spoke factorization with
complete dense spoke rank/unrank across all five S4 stabilizers and their
combined residual interval, and an exact
nested
S2-cubed
quotient/fixed-set
 decomposition,
