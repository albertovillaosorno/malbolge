...
formalizes one hundred thirty-four exact reductions: classic five-trit crazy
factorization,
...
second-layer stabilizers, an exact `(5,1)` nested S5 factorization with dense S2
