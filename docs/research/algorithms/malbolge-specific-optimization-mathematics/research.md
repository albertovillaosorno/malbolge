...
formalizes one hundred seventy-six exact reductions: classic five-trit crazy
factorization,
...
decomposition plus dense exact-S4 and exact-S3 rank/unrank for the remaining
all-equal stratum,
a generic
