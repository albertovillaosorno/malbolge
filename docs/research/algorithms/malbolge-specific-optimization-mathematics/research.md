...
formalizes two hundred twenty four exact reductions: classic five-trit crazy
factorization,
...
exact-transitive-order12, exact-transitive-order12-normalizer48, and
exact-transitive-order60 rank/unrank, and an exact repeated-six
