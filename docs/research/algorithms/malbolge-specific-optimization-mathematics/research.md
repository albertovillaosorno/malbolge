...
formalizes two hundred twenty three exact reductions: classic five-trit crazy
factorization,
...
exact-transitive-order12, and exact-transitive-order60 rank/unrank, and an exact
