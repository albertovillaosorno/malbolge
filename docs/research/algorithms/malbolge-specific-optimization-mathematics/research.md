...
formalizes one hundred forty-six exact reductions: classic five-trit crazy
factorization,
...
trivial, S2, S3, S4, and V4 second-layer rank/unrank plus a dense S3-times-S2
residual edge rank, where the S4 branch has
