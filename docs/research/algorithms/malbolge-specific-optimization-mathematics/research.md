...
formalizes one hundred twenty-five exact reductions: classic five-trit crazy
factorization,
...
`(4,1,1)` stratum with dense all-distinct and S2 second-layer rank/unrank, and
an exact nested S2-cubed quotient/fixed-set
 decomposition,
a generic
