...
formalizes two hundred twenty five exact reductions: classic five-trit crazy
factorization,
...
exact-A4-times-S2, and exact-transitive-order60 rank/unrank, and an exact
repeated-six exact-transposition outer composition for the remaining all-equal
stratum,
a generic
