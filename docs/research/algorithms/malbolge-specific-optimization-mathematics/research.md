...
formalizes two hundred sixteen exact reductions: classic five-trit crazy
factorization,
...
dense exact-S4, exact-S3, exact-C2-cubed, exact-S3-times-S2, and
exact-V4-(4,1,1) rank/unrank, and an exact repeated-six exact-transposition
