...
pub use direct::{
    CachedPreflightedExecutionTier, DIRECT_DEOPT_BACKEND_ID,
    DIRECT_DEOPT_BACKEND_REVISION, DIRECT_HALT_FETCH_BACKEND_ID,
    DIRECT_HALT_FETCH_BACKEND_REVISION, DIRECT_HALT_REGISTERS_BACKEND_ID,
    DIRECT_HALT_REGISTERS_BACKEND_REVISION, DIRECT_INITIAL_HALT_BACKEND_ID,
    DIRECT_INITIAL_HALT_BACKEND_REVISION, DIRECT_JUMP_CODE_BACKEND_ID,
    DIRECT_JUMP_CODE_BACKEND_REVISION, DIRECT_JUMP_DATA_BACKEND_ID,
    DIRECT_JUMP_DATA_BACKEND_REVISION, DIRECT_NO_OPERATION_BACKEND_ID,
    DIRECT_NO_OPERATION_BACKEND_REVISION, DIRECT_NON_GRAPHICAL_BACKEND_ID,
    DIRECT_NON_GRAPHICAL_BACKEND_REVISION, DirectCacheDisposition,
    DirectDeoptError, DirectHaltFetchError, DirectHaltRegistersError,
    DirectHost, DirectInitialHaltError, DirectJumpCodeError,
    DirectJumpDataError, DirectNativeKind, DirectNoOperationError,
    DirectNonGraphicalError, DirectSelectionError, PreflightedExecutionTier,
    VerifiedDeoptNativeObjectArtifact, VerifiedDirectNativeArtifact,
    VerifiedDirectNativeCache, VerifiedHaltFetchNativeObjectArtifact,
    VerifiedHaltRegistersNativeObjectArtifact,
    VerifiedInitialHaltNativeObjectArtifact,
    VerifiedJumpCodeNativeObjectArtifact, VerifiedJumpDataNativeObjectArtifact,
    VerifiedNoOperationNativeObjectArtifact,
    VerifiedNonGraphicalNativeObjectArtifact, emit_direct_deopt_coff,
    ...
    emit_direct_non_graphical_coff, select_cached_preflighted_execution_tier,
