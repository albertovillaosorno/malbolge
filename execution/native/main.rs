...
pub use direct::{
    ...
    DIRECT_DEOPT_BACKEND_REVISION, DIRECT_HALT_REGISTERS_BACKEND_ID,
    DIRECT_HALT_REGISTERS_BACKEND_REVISION, DIRECT_INITIAL_HALT_BACKEND_ID,
    DIRECT_INITIAL_HALT_BACKEND_REVISION, DIRECT_NON_GRAPHICAL_BACKEND_ID,
    DIRECT_NON_GRAPHICAL_BACKEND_REVISION, DirectCacheDisposition,
    DirectDeoptError, DirectHaltRegistersError, DirectHost,
    DirectInitialHaltError, DirectNativeKind, DirectNonGraphicalError,
    DirectSelectionError, PreflightedExecutionTier,
    VerifiedDeoptNativeObjectArtifact, VerifiedDirectNativeArtifact,
    VerifiedDirectNativeCache, VerifiedHaltRegistersNativeObjectArtifact,
