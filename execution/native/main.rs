...
pub use direct::{
    ...
    DIRECT_ROTATE_BACKEND_REVISION, DirectCacheDisposition, DirectDeoptError,
    ...
    DirectRotateError, DirectSelectionError, PreflightedExecutionTier,
    ...
    VerifiedRotateNativeObjectArtifact, emit_direct_deopt_coff,
