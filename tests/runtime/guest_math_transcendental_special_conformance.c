...
int main(void) {
  ...
  if (!expect(malbolge_guest_math_unary_special(
                  MALBOLGE_GUEST_MATH_SIN, UINT64_C(0x3e57000000000000)),
              MALBOLGE_GUEST_MATH_SPECIAL_RESOLVED,
              UINT64_C(0x3e57000000000000)) ||
      !expect(malbolge_guest_math_unary_special(
                  MALBOLGE_GUEST_MATH_SIN, UINT64_C(0xbe57000000000000)),
              MALBOLGE_GUEST_MATH_SPECIAL_RESOLVED,
              UINT64_C(0xbe57000000000000)) ||
      !expect(malbolge_guest_math_unary_special(
                  MALBOLGE_GUEST_MATH_COS, UINT64_C(0xbe40000000000000)),
              MALBOLGE_GUEST_MATH_SPECIAL_RESOLVED,
              UINT64_C(0x3ff0000000000000)) ||
      !expect(malbolge_guest_math_unary_special(
                  MALBOLGE_GUEST_MATH_SIN, UINT64_C(0x3e57000000000001)),
  ...
  if (!expect(malbolge_guest_math_atan2_special(
              ...
              MALBOLGE_GUEST_MATH_SPECIAL_RESOLVED,
              UINT64_C(0x3e0999999999999a)) ||
      !expect(malbolge_guest_math_atan2_special(
                  UINT64_C(0xbe30000000000000),
                  UINT64_C(0x4014000000000000)),
              MALBOLGE_GUEST_MATH_SPECIAL_RESOLVED,
