...
_FIXED_COMPONENTS = 2
_EXPECTED_TRIPLE_BLOCK_SIZES = (1, 1, 3, 3, 6, 6)
...
def test_pair_diagonal_s3_counts_match_independent_sequence() -> None:
...
def test_pair_diagonal_s3_rank_exhausts_masses_three_through_five() -> None:
...
def test_pair_diagonal_s3_rank_roundtrips_through_fourteen() -> None:
...
def test_pair_diagonal_s3_triple_geometry_and_counts() -> None:
...
def test_pair_diagonal_s3_branch_rank_roundtrips_through_fourteen() -> None:
