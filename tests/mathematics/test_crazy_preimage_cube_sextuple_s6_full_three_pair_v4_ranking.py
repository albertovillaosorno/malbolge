...
# Boundary-Contract:
# - Owns:
#   - Dense normalizer-free and exact rank/unrank for the three-pair V4
#     stabilizer in the top-level all-equal S6 residual stratum.
# - Must-Not:
#   - Claim dense rank for another exact full-S6 stabilizer type.
# - Allows:
#   - Inputs: H-fixed residual assignments for the three-pair V4 subgroup.
...
# - Summary:
#   - Rank the order-four normalizer quotient with no external exceptions.
# - Description:
#   - Normalizer-free already means exact-H for this subgroup.
# - Usage:
#   - Constructive rank for the three-pair V4 type.
# - Defaults:
#   - Exact residual and complete rank/unrank reach total mass fourteen.
#

"""Dense exact rank for the full-S6 three-pair V4 stabilizer."""
...
_EXPECTED_H_ORBIT_SIZES = {1: 8, 2: 10, 4: 6}
_EXPECTED_BLOCK_SIZES = (4, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2)
_EXPECTED_BLOCK_WEIGHTS = (1, 1, 1, 2, 2, 2, 2, 2, 4, 4, 4)
...
_SECOND_GENERATOR: _Permutation = (1, 0, 3, 2, 4, 5)
...
def test_three_pair_v4_normalizer_geometry_is_exact() -> None:
...
def test_three_pair_v4_free_rank_matches_exact_counts() -> None:
...
def test_three_pair_v4_exact_rank_roundtrips_through_fourteen() -> None:
...
def test_three_pair_v4_exact_samples_have_stabilizer_four() -> None:
...
def test_three_pair_v4_complete_rank_roundtrips_through_fourteen() -> None:
