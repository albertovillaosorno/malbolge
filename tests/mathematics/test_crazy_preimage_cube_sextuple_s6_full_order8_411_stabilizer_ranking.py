...
# Boundary-Contract:
# - Owns:
#   - Dense normalizer-free and exact rank/unrank for the order8-(4,1,1)
...
# - Usage:
#   - Constructive rank for the order8-(4,1,1) endpoint-orbit type.
# - Defaults:
#   - Exact residual and complete rank/unrank reach total mass fourteen.
#

"""Dense exact rank for the full-S6 order8-(4,1,1) stabilizer."""
...
_EXPECTED_H_ORBIT_SIZES = {1: 4, 2: 4, 4: 10}
_EXPECTED_BLOCK_SIZES = (4, 2, 4, 2, 2, 2, 2)
_EXPECTED_BLOCK_WEIGHTS = (1, 2, 4, 2, 4, 4, 4)
...
def test_order8_411_free_rank_matches_reviewed_counts() -> None:
...
def test_order8_411_minimal_extensions_match_exact_exclusions() -> None:
...
def test_order8_411_exact_rank_roundtrips_through_fourteen() -> None:
...
def test_order8_411_exact_samples_have_stabilizer_eight() -> None:
...
def test_order8_411_complete_rank_roundtrips_through_fourteen() -> None:
