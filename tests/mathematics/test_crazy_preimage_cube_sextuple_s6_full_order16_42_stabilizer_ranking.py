...
# Boundary-Contract:
# - Owns:
#   - Dense normalizer-free and exact rank/unrank for the order16-(4,2)
...
# - Usage:
#   - Constructive rank for the order16-(4,2) endpoint-orbit type.
# - Defaults:
#   - Exact residual and complete rank/unrank reach total mass fourteen.
#

"""Dense exact rank for the full-S6 order16-(4,2) stabilizer."""
...
_EXPECTED_H_ORBIT_SIZES = {1: 4, 2: 2, 4: 5, 8: 3}
_EXPECTED_BLOCK_SIZES = (4, 2, 5, 3)
_EXPECTED_BLOCK_WEIGHTS = (1, 2, 4, 8)
...
_THIRD_GENERATOR: _Permutation = (0, 1, 4, 5, 2, 3)
_FOURTH_GENERATOR: _Permutation = (1, 0, 2, 3, 4, 5)
_H_GENERATORS = (
    _FIRST_GENERATOR,
    _SECOND_GENERATOR,
    _THIRD_GENERATOR,
...
def test_order16_42_free_rank_matches_reviewed_counts() -> None:
...
def test_order16_42_minimal_extensions_match_exact_exclusions() -> None:
...
def test_order16_42_exact_rank_roundtrips_through_fourteen() -> None:
...
def test_order16_42_exact_samples_have_stabilizer_sixteen() -> None:
...
def test_order16_42_complete_rank_roundtrips_through_fourteen() -> None:
