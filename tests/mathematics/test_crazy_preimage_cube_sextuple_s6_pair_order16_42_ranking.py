...
#     stabilizer is order16-42 on three paired endpoint orbits.
# - Must-Not:
...
#   - Outputs: dense exact-order16-42 pair-graph ranks.
#   - Side effects: none.
# - Split-When:
...
# - Summary:
#   - Canonical blocks target the order16-42 conjugacy class.
# - Description:
#   - Interval Mobius coefficients isolate exact order16-42 stabilizers.
# - Usage:
...
"""Dense exact-order16-42 rank for pair-valued K6 edge graphs."""
...
_FIXED_COMPONENTS = 2
_EXPECTED_TRIPLE_BLOCK_SIZES = (4, 4, 4, 8)
...
def test_pair_order16_42_counts_match_independent_sequence() -> None:
    """Target-Mobius blocks reproduce exact order16-42 pair counts."""
...
def test_pair_order16_42_rank_exhausts_masses_three_through_five() -> None:
    """Every exact order16-42 pair rank through mass five roundtrips."""
...
def test_pair_order16_42_rank_roundtrips_through_fourteen() -> None:
    """Exact order16-42 pair ranks invert through mass fourteen."""
...
def test_pair_order16_42_triple_geometry_and_counts() -> None:
...
def test_pair_order16_42_branch_rank_roundtrips_through_fourteen() -> None:
