...
#     stabilizer is S3 on three paired endpoint orbits.
# - Must-Not:
...
#   - Outputs: dense exact-S3 pair-graph ranks.
#   - Side effects: none.
# - Split-When:
...
# - Summary:
#   - Canonical blocks target the S3 conjugacy class.
# - Description:
#   - Interval Mobius coefficients isolate exact S3 stabilizers.
# - Usage:
...
"""Dense exact-S3 rank for pair-valued K6 edge graphs."""
...
def test_pair_s3_counts_match_independent_sequence() -> None:
    """Target-Mobius blocks reproduce exact S3 pair counts."""
...
def test_pair_s3_rank_exhausts_masses_three_through_five() -> None:
    """Every exact S3 pair rank through mass five roundtrips."""
...
def test_pair_s3_rank_roundtrips_through_fourteen() -> None:
    """Exact S3 pair ranks invert through mass fourteen."""
...
def test_pair_s3_triple_geometry_and_counts() -> None:
...
def test_pair_s3_branch_rank_roundtrips_through_fourteen() -> None:
