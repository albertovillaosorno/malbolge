...
#     stabilizer is D10 on three paired endpoint orbits.
# - Must-Not:
...
#   - Outputs: dense exact-D10 pair-graph ranks.
#   - Side effects: none.
# - Split-When:
...
# - Summary:
#   - Canonical blocks target the D10 conjugacy class.
# - Description:
#   - Interval Mobius coefficients isolate exact D10 stabilizers.
# - Usage:
...
"""Dense exact-D10 rank for pair-valued K6 edge graphs."""
...
_FIXED_COMPONENTS = 2
_EXPECTED_TRIPLE_BLOCK_SIZES = (5, 5, 5, 5)
_EXPECTED_TARGET_CONJUGATES = 36
...
def test_pair_d10_51_counts_match_independent_sequence() -> None:
    """Target-Mobius blocks reproduce exact D10 pair counts."""
...
def test_pair_d10_51_rank_exhausts_masses_three_through_five() -> None:
    """Every exact D10 pair rank through mass five roundtrips."""
...
def test_pair_d10_51_rank_roundtrips_through_fourteen() -> None:
    """Exact D10 pair ranks invert through mass fourteen."""
...
def test_pair_d10_51_triple_geometry_and_counts() -> None:
...
def test_pair_d10_51_branch_rank_roundtrips_through_fourteen() -> None:
