...
#     stabilizer is diagonal-S3 on three paired endpoint orbits.
# - Must-Not:
...
#   - Outputs: dense exact-diagonal-S3 pair-graph ranks.
#   - Side effects: none.
# - Split-When:
...
# - Summary:
#   - Canonical blocks target the diagonal-S3 conjugacy class.
# - Description:
#   - Interval Mobius coefficients isolate exact diagonal-S3 stabilizers.
# - Usage:
...
"""Dense exact-diagonal-S3 rank for pair-valued K6 edge graphs."""
...
_FIXED_COMPONENTS = 2
_EXPECTED_TRIPLE_BLOCK_SIZES = (2, 6, 6, 6)
_EXPECTED_TARGET_CONJUGATES = 20
_EXPECTED_TARGET_INVOLUTIONS = 3
...
def test_pair_transitive_s3_6_counts_match_independent_sequence() -> None:
    """Target-Mobius blocks reproduce exact diagonal-S3 pair counts."""
...
def test_pair_transitive_s3_6_rank_exhausts_masses_three_through_five() -> None:
    """Every exact diagonal-S3 pair rank through mass five roundtrips."""
...
def test_pair_transitive_s3_6_rank_roundtrips_through_fourteen() -> None:
    """Exact diagonal-S3 pair ranks invert through mass fourteen."""
...
def test_pair_transitive_s3_6_triple_geometry_and_counts() -> None:
...
def test_pair_transitive_s3_6_branch_rank_roundtrips_through_fourteen() -> None:
