...
#     stabilizer is transitive-order48 on three paired endpoint orbits.
# - Must-Not:
...
#   - Outputs: dense exact-transitive-order48 pair-graph ranks.
#   - Side effects: none.
# - Split-When:
...
# - Summary:
#   - Canonical blocks target the transitive-order48 conjugacy class.
# - Description:
#   - Interval Mobius coefficients isolate exact transitive-order48 stabilizers.
# - Usage:
...
"""Dense exact-transitive-order48 rank for pair-valued K6 edge graphs."""
...
_FIXED_COMPONENTS = 2
_EXPECTED_TRIPLE_BLOCK_SIZES = (12, 8)
...
def test_pair_transitive_order48_counts_match_independent_sequence() -> None:
    """Target-Mobius blocks reproduce exact transitive-order48 pair counts."""
...
def test_pair_transitive_order48_rank_exhausts_masses_three_through_five() -> (
    None
):
    """Every exact transitive-order48 pair rank through mass five roundtrips."""
...
def test_pair_transitive_order48_rank_roundtrips_through_fourteen() -> None:
    """Exact transitive-order48 pair ranks invert through mass fourteen."""
...
def test_pair_transitive_order48_triple_geometry_and_counts() -> None:
...
def test_pair_transitive_order48_branch_rank_roundtrips_through_fourteen() -> (
    None
):
