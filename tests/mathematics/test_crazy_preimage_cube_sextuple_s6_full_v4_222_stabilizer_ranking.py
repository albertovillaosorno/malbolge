...
# Boundary-Contract:
# - Owns:
#   - Dense normalizer-free and exact rank/unrank for the V4-(2,2,2)
#     stabilizer in the top-level all-equal S6 residual stratum.
# - Must-Not:
#   - Claim dense rank for another exact full-S6 stabilizer type.
# - Allows:
#   - Inputs: H-fixed residual assignments for the V4-(2,2,2) subgroup.
...
# - Usage:
#   - Constructive rank for the exact V4 endpoint-orbit-(2,2,2) type.
# - Defaults:
#   - Exact residual and complete rank/unrank reach total mass fourteen.
#

"""Dense exact rank for the full-S6 V4-(2,2,2) stabilizer."""
...
_EXPECTED_H_ORBIT_SIZES = {1: 8, 2: 6, 4: 8}
_EXPECTED_BLOCK_SIZES = (2, 6, 3, 3, 3, 3, 2)
_EXPECTED_BLOCK_WEIGHTS = (1, 2, 1, 1, 4, 4, 4)
...
def test_v4_222_normalizer_geometry_is_exact() -> None:
...
def test_v4_222_free_rank_matches_exact_counts() -> None:
...
def test_v4_222_exact_rank_roundtrips_through_fourteen() -> None:
...
def test_v4_222_exact_samples_have_stabilizer_four() -> None:
...
def test_v4_222_complete_rank_roundtrips_through_fourteen() -> None:
