...
#     stabilizer is S4-(4,1,1) on three paired endpoint orbits.
# - Must-Not:
...
#   - Outputs: dense exact-S4-(4,1,1) pair-graph ranks.
#   - Side effects: none.
# - Split-When:
...
# - Summary:
#   - Canonical blocks target the S4-(4,1,1) conjugacy class.
# - Description:
#   - Interval Mobius coefficients isolate exact S4-(4,1,1) stabilizers.
# - Usage:
...
"""Dense exact-S4-(4,1,1) rank for pair-valued K6 edge graphs."""
...
_FIXED_COMPONENTS = 2
_EXPECTED_TRIPLE_BLOCK_SIZES = (4, 4, 6, 6)
...
def test_pair_s4_411_counts_match_independent_sequence() -> None:
    """Target-Mobius blocks reproduce exact S4-(4,1,1) pair counts."""
...
def test_pair_s4_411_rank_exhausts_masses_three_through_five() -> None:
    """Every exact S4-(4,1,1) pair rank through mass five roundtrips."""
...
def test_pair_s4_411_rank_roundtrips_through_fourteen() -> None:
    """Exact S4-(4,1,1) pair ranks invert through mass fourteen."""
...
def test_pair_s4_411_triple_geometry_and_counts() -> None:
...
def test_pair_s4_411_branch_rank_roundtrips_through_fourteen() -> None:
