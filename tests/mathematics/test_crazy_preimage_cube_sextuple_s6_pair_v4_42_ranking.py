...
#     stabilizer is V4-42 on three paired endpoint orbits.
# - Must-Not:
...
#   - Outputs: dense exact-V4-42 pair-graph ranks.
#   - Side effects: none.
# - Split-When:
...
# - Summary:
#   - Canonical blocks target the V4-42 conjugacy class.
# - Description:
#   - Interval Mobius coefficients isolate exact V4-42 stabilizers.
# - Usage:
...
"""Dense exact-V4-42 rank for pair-valued K6 edge graphs."""
...
def test_pair_v4_42_counts_match_independent_sequence() -> None:
    """Target-Mobius blocks reproduce exact V4-42 pair counts."""
...
def test_pair_v4_42_rank_exhausts_masses_three_through_five() -> None:
    """Every exact V4-42 pair rank through mass five roundtrips."""
...
def test_pair_v4_42_rank_roundtrips_through_fourteen() -> None:
    """Exact V4-42 pair ranks invert through mass fourteen."""
...
def test_pair_v4_42_triple_geometry_and_counts() -> None:
...
def test_pair_v4_42_branch_rank_roundtrips_through_fourteen() -> None:
