...
#     stabilizer is V4-411 on three paired endpoint orbits.
# - Must-Not:
...
#   - Outputs: dense exact-V4-411 pair-graph ranks.
#   - Side effects: none.
# - Split-When:
...
# - Summary:
#   - Canonical blocks target the V4-411 conjugacy class.
# - Description:
#   - Interval Mobius coefficients isolate exact V4-411 stabilizers.
# - Usage:
...
"""Dense exact-V4-411 rank for pair-valued K6 edge graphs."""
...
def test_pair_v4_411_counts_match_independent_sequence() -> None:
    """Target-Mobius blocks reproduce exact V4-411 pair counts."""
...
def test_pair_v4_411_rank_exhausts_masses_three_through_eight() -> None:
    """Every exact V4-411 pair rank through mass eight roundtrips."""
...
def test_pair_v4_411_rank_roundtrips_through_fourteen() -> None:
    """Exact V4-411 pair ranks invert through mass fourteen."""
...
def test_pair_v4_411_triple_geometry_and_counts() -> None:
...
def test_pair_v4_411_branch_rank_roundtrips_through_fourteen() -> None:
