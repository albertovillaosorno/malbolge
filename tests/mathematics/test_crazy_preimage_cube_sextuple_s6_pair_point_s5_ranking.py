...
#     stabilizer is point-S5 on three paired endpoint orbits.
# - Must-Not:
...
#   - Outputs: dense exact-point-S5 pair-graph ranks.
#   - Side effects: none.
# - Split-When:
...
# - Summary:
#   - Canonical blocks target the point-S5 conjugacy class.
# - Description:
#   - Interval Mobius coefficients isolate exact point-S5 stabilizers.
# - Usage:
...
"""Dense exact-point-S5 rank for pair-valued K6 edge graphs."""
...
_FIXED_COMPONENTS = 2
_EXPECTED_TRIPLE_BLOCK_SIZES = (10, 10)
_EXPECTED_TARGET_CONJUGATES = 6
_HARD_BLOCK_SIZE = 10
...
def test_pair_point_s5_counts_match_independent_sequence() -> None:
    """Target-Mobius blocks reproduce exact point-S5 pair counts."""
...
def test_pair_point_s5_rank_exhausts_masses_three_through_five() -> None:
    """Every exact point-S5 pair rank through mass five roundtrips."""
...
def test_pair_point_s5_rank_roundtrips_through_fourteen() -> None:
    """Exact point-S5 pair ranks invert through mass fourteen."""
...
def test_pair_point_s5_triple_geometry_and_counts() -> None:
...
def test_pair_point_s5_branch_rank_roundtrips_through_fourteen() -> None:
