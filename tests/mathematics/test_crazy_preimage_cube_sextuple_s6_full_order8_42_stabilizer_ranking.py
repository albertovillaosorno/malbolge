...
# Boundary-Contract:
# - Owns:
#   - Dense normalizer-free and exact rank/unrank for the order8-(4,2)
...
# - Usage:
#   - Constructive rank for the order8-(4,2) endpoint-orbit type.
# - Defaults:
#   - Exact residual and complete rank/unrank reach total mass fourteen.
#

"""Dense exact rank for the full-S6 order8-(4,2) stabilizer."""
...
_EXPECTED_H_ORBIT_SIZES = {1: 4, 2: 4, 4: 8, 8: 1}
_EXPECTED_BLOCK_SIZES = (4, 2, 4, 1, 2, 2, 2)
_EXPECTED_BLOCK_WEIGHTS = (1, 2, 4, 8, 2, 4, 4)
...
def test_order8_42_normalizer_geometry_is_exact() -> None:
...
def test_order8_42_free_rank_matches_reviewed_counts() -> None:
...
def test_order8_42_minimal_extensions_match_exact_exclusions() -> None:
...
def test_order8_42_exact_rank_roundtrips_through_fourteen() -> None:
...
def test_order8_42_exact_samples_have_stabilizer_eight() -> None:
...
def test_order8_42_complete_rank_roundtrips_through_fourteen() -> None:
