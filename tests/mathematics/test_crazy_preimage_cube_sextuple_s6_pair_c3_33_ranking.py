...
_FIXED_COMPONENTS = 2
_EXPECTED_TRIPLE_BLOCK_SIZES = (1, 1, 3, 3, 3, 3, 3, 3)
...
def test_pair_c3_33_counts_match_independent_sequence() -> None:
...
def test_pair_c3_33_rank_exhausts_masses_three_through_nine() -> None:
    """Every exact diagonal-S3 pair rank through mass nine roundtrips."""
...
def test_pair_c3_33_rank_roundtrips_through_fourteen() -> None:
...
def test_pair_c3_33_triple_geometry_and_counts() -> None:
...
def test_pair_c3_33_branch_rank_roundtrips_through_fourteen() -> None:
