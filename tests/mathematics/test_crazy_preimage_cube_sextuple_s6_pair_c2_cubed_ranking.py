...
#     stabilizer is C2-cubed on three paired endpoint orbits.
# - Must-Not:
...
#   - Outputs: dense exact-C2-cubed pair-graph ranks.
#   - Side effects: none.
# - Split-When:
...
# - Summary:
#   - Canonical blocks target the C2-cubed conjugacy class.
# - Description:
#   - Interval Mobius coefficients isolate exact C2-cubed stabilizers.
# - Usage:
...
"""Dense exact-C2-cubed rank for pair-valued K6 edge graphs."""
...
_FIXED_COMPONENTS = 2
_EXPECTED_TRIPLE_BLOCK_SIZES = (2, 2, 2, 2, 2, 2, 8)
...
def test_pair_c2_cubed_counts_match_independent_sequence() -> None:
    """Target-Mobius blocks reproduce exact C2-cubed pair counts."""
...
def test_pair_c2_cubed_rank_exhausts_masses_three_through_five() -> None:
    """Every exact C2-cubed pair rank through mass five roundtrips."""
...
def test_pair_c2_cubed_rank_roundtrips_through_fourteen() -> None:
    """Exact C2-cubed pair ranks invert through mass fourteen."""
...
def test_pair_c2_cubed_triple_geometry_and_counts() -> None:
...
def test_pair_c2_cubed_branch_rank_roundtrips_through_fourteen() -> None:
