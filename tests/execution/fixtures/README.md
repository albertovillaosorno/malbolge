...
The eighteen `native-*-coff.hex` fixtures freeze the complete direct Windows COFF
...
revision 1 use metadata v3. Exact x86-64/AArch64 object sizes are 413/415 bytes for
deopt,
